      ...
      <section className="section-light pb-20 lg:pb-28">
        <div className="container-page">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {values.map((value) => (
              <div key={value.title} className="p-8 rounded-2xl bg-muted">
            ...
            <div className="bg-dark/50 rounded-2xl p-8 border border-dark-foreground/10">
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-3 rounded-lg bg-dark-foreground/10 border border-dark-foreground/20 text-dark-foreground placeholder:text-dark-foreground/50 focus:outline-none focus:border-accent"
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 rounded-lg bg-dark-foreground/10 border border-dark-foreground/20 text-dark-foreground placeholder:text-dark-foreground/50 focus:outline-none focus:border-accent resize-none"
